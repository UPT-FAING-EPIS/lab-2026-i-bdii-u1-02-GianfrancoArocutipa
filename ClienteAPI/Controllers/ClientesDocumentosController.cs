...
namespace ClienteAPI.Controllers
{
    ...
    public class ClientesDocumentosController : ControllerBase
    {
        ...
        {
            if (id != clientesDocumento.IdClienteDocumento)
            {
                return BadRequest();
            }
        ...
        public async Task<ActionResult<ClientesDocumento>> PostClientesDocumento(ClientesDocumento clientesDocumento)
        {
            ...
            return CreatedAtAction("GetClientesDocumento", new { id = clientesDocumento.IdClienteDocumento }, clientesDocumento);
        }
        ...
        {
            return _context.ClientesDocumentos.Any(e => e.IdClienteDocumento == id);
        }
    }
}
